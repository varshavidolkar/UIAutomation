...
// const e2ePath = path.resolve('tests');
// const lodashESDep = path.resolve('node_modules', 'lodash-es');
...
//         function(pathName) {
//             return (
//                 pathName.indexOf(e2ePath) !== -1 ||
//                 pathName.indexOf(lodashESDep) !== -1
//             );
//         }
//     ]
// });
...
exports.config = {
    ...
    cucumberOpts: {
        ...
        require: ['./tests/features/step_definitions/*.js', './tests/features/support/*.js','./tests/pages/*.js'],        // <string[]> (file/dir) require files before executing features
